...
import postTitles from '../app/diffr/blog/post-titles.json'
import { getSceneBrandKit } from '../app/diffr/start/lib'
import { BLOG_SLUG_TO_PRESET } from '../app/diffr/blog/[slug]/page'
import { hasDynamicOgCard, ogBaseLocalPath, ogBaseUrl } from '../app/diffr/blog/og-base'
...
export async function renderDynamicOgCard(
  _req: Request,
