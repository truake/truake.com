...
export const BLOG_SLUG_TO_START: Record<string, string> = {
  ...
  'unusual-edc-brand-guide': 'unusual-edc-kit',
  'wimb-speedy-brand-guide': 'wimb-speedy-kit',
  'styling-day-date-brand-guide': 'ootd-day-date-kit',
  'under-100-edc-brand-guide': 'under-100-edc-kit',
  'wimb-parisa-wang-brand-guide': 'wimb-parisa-wang-kit',
  'styling-green-pants-brand-guide': 'ootd-green-pants-kit',
  'blackout-titanium-edc-brand-guide': 'blackout-titanium-edc-kit',
  'wimb-rachel-zoe-brand-guide': 'wimb-rachel-zoe-kit',
  'styling-navy-uniform-brand-guide': 'ootd-navy-uniform-kit',
  'best-new-edc-2026-brand-guide': 'best-new-edc-2026-kit',
  'wimb-straw-tote-brand-guide': 'wimb-straw-tote-kit',
  'styling-tabby-boots-brand-guide': 'ootd-tabby-boots-kit',
  'budget-edc-under-30-brand-guide': 'budget-edc-under-30-kit',
  'wimb-teddy-blake-brand-guide': 'wimb-teddy-blake-kit',
  'styling-overcoat-brand-guide': 'ootd-overcoat-kit',
  'micro-edc-brand-guide': 'micro-edc-kit',
  'wimb-dark-brown-satchel-brand-guide': 'wimb-dark-brown-satchel-kit',
  'styling-brown-leather-jacket-brand-guide': 'ootd-brown-leather-jacket-kit',
  'garage-on-your-feet-brand-guide': 'garage-on-your-feet-kit',
